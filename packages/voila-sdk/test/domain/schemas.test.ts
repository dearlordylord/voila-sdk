      ...
      decoratedProducts: [
        {
          ...
          price: { amount: "5.69", currency: "CAD" },
          productId: "b952bad2-3d09-4b7f-831a-87ad31eaad3f",
          quantityInBasket: 0,
          retailerProductId: "243255EA",
          unitPrice: { price: { amount: "0.28", currency: "CAD" }, unit: "fop.price.per.100ml", unitName: "PER_100ML" }
        }
      ],
      type: "featured"
    }
...
const sampleCartUpdateResponse = {
  basketUpdateResult: {
    itemGroups: [
      {
        items: [
          {
            finalPrice: { amount: "5.69", currency: "CAD" },
            maxQuantityReached: false,
            price: { amount: "5.69", currency: "CAD" },
            productId: "b952bad2-3d09-4b7f-831a-87ad31eaad3f",
            quantity: 1
    ...
    totals: {
      itemPriceAfterPromos: { amount: "5.69", currency: "CAD" },
      itemsRetailPrice: { amount: "5.69", currency: "CAD" },
